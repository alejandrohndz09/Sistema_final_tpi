                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form method="POST">
                                        @csrf
                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Ingresar a Mi
                                            Cuenta</h5>
                                        ...
                                        <div class="form-outline mb-4">
                                            <input type="password" class="form-control form-control-lg" id="contraseña"
                                                name="contraseña" spellcheck="false" autocorrect="off"
                                                autocapitalize="off" />
                                            <label for="form2Example27">Contraseña</label>
                                        </div>
                                        <div class="pt-1 mb-5">
                                            <button class="btn btn-dark btn-lg btn-block" type="submit"
                                                style="background-color: #100d94;">Ingresar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
>>>>>>> 654a118f5f91fdb9d7d39014512d9110c292ab6a
                    </div>
                </div>
            </div>
        </div>
